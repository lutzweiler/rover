...
use super::cam2d::camera_2d_movement_system;
use crate::bevy_fly_camera::util::movement_axis;
use bevy::{input::mouse::MouseMotion, prelude::*};

pub use super::cam2d::FlyCamera2d;
...
fn camera_movement_system(
    ...
    for (mut options, mut transform) in query.iter_mut() {
        ...
        let accel: Vec3 =
            (strafe_vector(&rotation) * axis_h) + (forward_walk_vector(&rotation) * axis_v) + (Vec3::Y * axis_float);
